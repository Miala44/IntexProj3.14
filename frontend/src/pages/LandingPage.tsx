...
import './LandingPage.css'; // Ensure this is imported for styles!
  ...
  return (
    <div className="landing-page-container">
      <div className="auth-buttons">
        ...
        <button className="btn-google" onClick={() => navigate('/register')}>
          Create Account
        </button>
      </div>
