...
public partial class MovieDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("movies_ratings");      // :white_check_mark: First
            entity.HasKey(e => e.UserId);          // :white_check_mark: Second
        ...
        {
            entity.ToTable("movies_users");        // :white_check_mark: Called first
            entity.HasKey(e => e.UserId);          // :white_check_mark: Separate line
            entity.Property(e => e.UserId).HasColumnName("user_id");
